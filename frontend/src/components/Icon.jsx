// Lightweight inline SVG icon set (Lucide-style). Stroke uses currentColor.
...
const P = {
  ...
  wallet: <><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 1-1 1v2a1 1 0 0 1-1 1H5a2 2 0 0 1-2-2V5" /><path d="M18 12h.01" /></>,
  layers: <><path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.84z" /><path d="m2 12.65 9.17 4.16a2 2 0 0 0 1.66 0L22 12.65" /><path d="m2 17.65 9.17 4.16a2 2 0 0 0 1.66 0L22 17.65" /></>,
